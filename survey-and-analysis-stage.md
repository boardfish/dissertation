...
In the meantime, escape room owners are able to apply technology to varying degrees, implementing leaderboards, sharing team photos to social media, and interacting with the team via a screen in the room. One application I have personally witnessed was for a hidden camera to take a photo of the team, apply filters, and display the photo among works of art in The Gallery<!-- TODO: cite The Gallery -->.
